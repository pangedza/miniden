...
- Для карточек товаров и мастер-классов выводится краткое описание (`short_description`). Полное описание открывается в модальном окне «Подробнее» вместе с ценой и кнопкой «Добавить в корзину» или переходом к уроку.
