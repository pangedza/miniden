...
--------------------------------------
1. Открыть бота, добавить товар в корзину через WebApp или команды каталога.
2. Нажать «🛒 Корзина» в боте и убедиться, что отображается список позиций и кнопка «💳 Оформить заказ».
3. Нажать «💳 Оформить заказ», ввести имя, контакт и комментарий (или `-`).
4. Убедиться, что бот отвечает «✅ Заказ создан» и номером заказа.
5. Проверить, что запись появилась в БД через SQL из задачи 1.
