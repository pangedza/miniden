...
-------------------------
- Все HTML-страницы WebApp подключают локальные js/css-файлы с параметром версии (`?v=20241203`), чтобы браузеры (особенно Яндекс.Браузер и мобильные) не держали устаревший кэш.
