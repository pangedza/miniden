...
-----------------------------
- 2026-04-XX: Обработчик валидации использует fastapi.encoders.jsonable_encoder, чтобы корректно сериализовать ValidationInfo на Pydantic v2 и возвращать 422 в формате JSON вместо 500.
...
- При выборе файла фронтенд отправляет FormData на `/api/admin/home/upload_image`, backend сохраняет изображение в `/opt/miniden/media/home/` и возвращает путь вида `/media/home/<uuid>.<ext>`.
